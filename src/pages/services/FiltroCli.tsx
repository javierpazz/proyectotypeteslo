...
export const FiltroCli = () => {
    ...
    useEffect(() => {
        if (!user && !isLoading) {
        navigate('/auth/login?redirect=/services/filtrocli');
        }
        // if (user?.role === "client" ) {
        // navigate('/');
        // }
...
desVal;
  ...
  const placeInvoiceHandler = async () => {
    if (window.confirm('Esta seguro de Grabar Parametros?')) {
      ...
      filtro.codMaq = codMaq;
      filtro.nameMaq = nameMaq;
              ...
              <Grid item md={2}>
                  ...
                  <FormControl fullWidth >
                    ...
                    <Select
                      ...
                      >
                      <MenuItem value="TOD">Todos Trabajos/Tareas </MenuItem>
