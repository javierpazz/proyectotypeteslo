...
/////////////////consulta instrumento
  ...
  const orderHandler = async () => {
    try {
      ...
      setIsloading(false);
      navigate(`/admin/invoicerRecCon/${data.receipt._id}?redirect=/admin/invoicerRec`);
    ...
    {!showInvoice ? (
      ...
      <Box border={1} p={2} borderRadius={2}>
        ...
        <Grid container>
          ...
          <Grid item md={4}>
                    <Typography variant="h1">RECIBO</Typography>
          </Grid>
        </Grid>
