...
/////////////////consulta instrumento
  ...
  const placeInvoiceHandler = async () => {
      ...
      if (!isPaying && ( !recDat || !desVal)) {
        ...
        if (invDat) {
          ...
          // );
          // invoice.totalBuy = 0;
          invoice.codCus = invoiceA.id_client;
  ...
  const clearitems = () => {
            navigate(`/admin/invoicerRemCon/${id}?redirect=/admin/remits`);
    ...
    {!showInvoice ? (
      ...
      <Box border={1} p={2} borderRadius={2}>
        ...
        <Grid container>
          ...
          <Grid item md={6}>
                    <Typography variant="h1">COMPROBANTE DESDE REMITO</Typography>
          </Grid>
        </Grid>
