...
import { IConfiguracion, ICustomer,  IOrder } from '../../interfaces';
    ...
    const loadProduct = async() => {
        try {
            ...
            //    paymentResult: '',
                ...
                id_config2      : resp.data.id_config2,
                ...
                movpvNum      : resp.data.movpvNum,
                movpvDat      : resp.data.movpvDat,
        ...
        <Box mt={4}>
          <Paper variant="outlined" sx={{ p: 2 }}>
            <Box bgcolor="black" color="white" p={1} textAlign="center">
              <Typography variant="h6">RECEPCION DESDE PTO DE VENTA</Typography>
            </Box>
            ...
            <Grid container spacing={2} mt={2}>
              ...
              <Grid item xs={12} md={6}>
                <Typography><strong>ENTREGA A PTO DE VENTA</strong></Typography>
                <Typography><strong>Punto de Venta:</strong> {config.salePoint}</Typography>
                <Typography><strong>Comp. Nro:</strong> {invoice.movpvNum}</Typography>
                <Typography><strong>Fecha de Emision:</strong> {invoice.movpvDat?.substring(0, 10)}</Typography>
            ...
            <Grid container spacing={2}>
              <Grid item xs={12} md={6}>
                <Typography><strong>CUIT:</strong> {(invoice.id_config2 as IConfiguracion)?.cuit}</Typography>
                <Typography><strong>Condición IVA:</strong> {(invoice.id_config2 as IConfiguracion)?.coniva}</Typography>
              </Grid>
              <Grid item xs={12} md={6}>
                <Typography><strong>Apellido y Nombre / Razon Social:</strong> {(invoice.id_config2 as IConfiguracion)?.name}</Typography>
                <Typography><strong>Dirección:</strong> {(invoice.id_config2 as IConfiguracion)?.domcomer}</Typography>
              </Grid>
            </Grid>
