...
export const EntradaRegSinTerListScreen = () => {
    ...
    useEffect(() => {
        if (!user && !isLoading) {
        navigate('/auth/login?redirect=/admin/entradasrst');
        }
    ...
    const loadData = async() => {
        ...
        // });
          const resp = await stutzApi.get('/api/invoices/searchremSEscRST');
  ...
  return (
    <AdminLayoutMenuList
        title={'Entradas'} 
        subTitle={'Entradas Registradas sin Terminar'}
