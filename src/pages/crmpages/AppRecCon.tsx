        ...
        <Box mt={4}>
          <Paper variant="outlined" sx={{ p: 2 }}>
            ...
            <Grid container spacing={2} mt={2}>
              ...
              <Grid item xs={12} md={6}>
                <Typography><strong>INGRESO DE CAJA</strong></Typography>
            ...
            <Grid container spacing={2}>
              <Grid item xs={12} md={6}>
                <Typography><strong>CUIT:</strong> {(receipt.id_client as ICustomer)?.cuit}</Typography>
                <Typography><strong>Condición IVA:</strong> {(receipt.id_client as ICustomer)?.coniva}</Typography>
              </Grid>
              <Grid item xs={12} md={6}>
                <Typography><strong>Apellido y Nombre / Razon Social:</strong> {(receipt.id_client as ICustomer)?.nameCus}</Typography>
                <Typography><strong>Dirección:</strong> {(receipt.id_client as ICustomer)?.domcomer}</Typography>
              </Grid>
            </Grid>
            ...
            <Box mt={2} textAlign="right">
              <Typography variant="h6"><strong>Total:</strong> ${receipt.total?.toFixed(2)}</Typography>
            </Box>
          </div>
          </Paper>
        </Box>
